                    ...
                    <div>
                      ...
                      <div className="mt-1">
                        <input
                          ...
                          className="py-3 border border-black px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md"
                        />
                      </div>
                    </div>
                    <div>
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="mt-1">
                        <textarea
                          ...
                          name="message"
                          rows={4}
                          className="py-3 border border-black px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border border-warm-gray-300 rounded-md"
